...
{
    public function prepend(mixed $node): Query
    {
    ...
    public function optGroup(iterable $data, Closure|string|null $getter): self
    {
    ...
    public function ds(iterable $datasource, Closure|string|null $display_member = null, Closure|string|null $value_member = null): self
    {
        foreach ($this as $select) {
            if (!$value_member) {
